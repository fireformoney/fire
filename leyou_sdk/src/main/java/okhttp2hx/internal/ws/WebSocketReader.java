 ...
 */
package okhttp2hx.internal.ws;

import java.io.EOFException;
import java.io.IOException;
import java.net.ProtocolException;
import java.util.concurrent.TimeUnit;
import okio2hx.Buffer;
import okio2hx.BufferedSource;
import okio2hx.ByteString;

import static java.lang.Integer.toHexString;
import static okhttp2hx.internal.ws.WebSocketProtocol.B0_FLAG_FIN;
import static okhttp2hx.internal.ws.WebSocketProtocol.B0_FLAG_RSV1;
import static okhttp2hx.internal.ws.WebSocketProtocol.B0_FLAG_RSV2;
import static okhttp2hx.internal.ws.WebSocketProtocol.B0_FLAG_RSV3;
import static okhttp2hx.internal.ws.WebSocketProtocol.B0_MASK_OPCODE;
import static okhttp2hx.internal.ws.WebSocketProtocol.B1_FLAG_MASK;
import static okhttp2hx.internal.ws.WebSocketProtocol.B1_MASK_LENGTH;
import static okhttp2hx.internal.ws.WebSocketProtocol.CLOSE_NO_STATUS_CODE;
import static okhttp2hx.internal.ws.WebSocketProtocol.OPCODE_BINARY;
import static okhttp2hx.internal.ws.WebSocketProtocol.OPCODE_CONTINUATION;
import static okhttp2hx.internal.ws.WebSocketProtocol.OPCODE_CONTROL_CLOSE;
import static okhttp2hx.internal.ws.WebSocketProtocol.OPCODE_CONTROL_PING;
import static okhttp2hx.internal.ws.WebSocketProtocol.OPCODE_CONTROL_PONG;
import static okhttp2hx.internal.ws.WebSocketProtocol.OPCODE_FLAG_CONTROL;
import static okhttp2hx.internal.ws.WebSocketProtocol.OPCODE_TEXT;
import static okhttp2hx.internal.ws.WebSocketProtocol.PAYLOAD_BYTE_MAX;
import static okhttp2hx.internal.ws.WebSocketProtocol.PAYLOAD_LONG;
import static okhttp2hx.internal.ws.WebSocketProtocol.PAYLOAD_SHORT;
import static okhttp2hx.internal.ws.WebSocketProtocol.toggleMask;
